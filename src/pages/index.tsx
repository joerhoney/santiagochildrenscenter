...
const logo = "/assets/icons/Santiago-Childrens-Center-logo.svg";
const stars = "/assets/icons/5-stars.svg";
const yelp = "/assets/icons/yelp.svg";
const children_watching_turtle_ai2x =
  "/assets/photos/children_watching_turtle_ai2x.jpg";
const children_watching_terrarium_ai2x =
  "/assets/photos/children_watching_terrarium_ai2x.jpg";
const children_looking_at_horse =
  "/assets/photos/children_looking_at_horse.webp";
const girl_n_horse_looking_at_each_other =
  "/assets/photos/girl_n_horse_looking_at_each_other.jpg";
const diversity_3_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/diversity_3_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const celebration_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/celebration_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const forum_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/forum_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const volunteer_activism_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/volunteer_activism_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const multimodal_hand_eye_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/multimodal_hand_eye_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const children_on_patio_ai4x = "/assets/photos/children_on_patio_ai4x.jpg";
const girl_on_pony_graded = "/assets/photos/girl_on_pony_graded.webp";
const JeriD = "/assets/testimonials/JeriD.jpg";
const GivannaN = "/assets/testimonials/GivannaN.jpg";
const CourtneyT = "/assets/testimonials/CourtneyT.jpg";
const schedule_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/schedule_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const flag_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24 =
  "/assets/icons/flag_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg";
const children_grooming_horse = "/assets/photos/children_grooming_horse.webp";
const children_playing_on_playground =
  "/assets/photos/children_playing_on_playground.webp";
const children_n_teacher = "/assets/photos/children_n_teacher.webp";
  ...
  return (
    <>
      {/* 
        ...
        =======
      */}
      <section className="section py-8 md:flex md:gap-8 md:py-12">
        <div className="md:w-5/12">
          <img
            src="/assets/icons/Santiago-Childrens-Center-logo.svg"
          ...
          <div className="stacker gap-8 py-8 text-center md:gap-8 lg:place-items-start lg:py-12">
            ...
            <div className="m-auto max-w-max text-center md:ml-0 md:w-max md:text-left">
      ...
      */}
      ...
      {/* 
        ...
        =======================
      */}
      <section className="section flex flex-col py-8 md:flex-row md:py-12">
